...
struct Course {
  ...
  std::string description;
  Id teacher_id{};
  AnswerPolicy answer_policy{AnswerPolicy::Guided};
};

struct TeacherConfiguration {
  Id id{};
  Id teacher_id{};
  Id course_id{};
...
struct Message {
  ...
  std::string role;
  std::string content;
  std::optional<int> token_input;
  std::optional<int> token_output;
  std::string model;
};
...
struct ThinkingAssessment {
  ...
  std::optional<double> teacher_score;
  std::optional<std::string> teacher_feedback;
